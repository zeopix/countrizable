...
module Countrizable
  module Test
    module Database
      ...
      COUNTRIZABLE_LOG = File.expand_path('../../countrizable_test.log', __FILE__)
      ...
      def connect
        ...
        driver  = Countrizable::Test::Database.driver
        engine  = RUBY_ENGINE rescue 'ruby'

        FileUtils.touch(COUNTRIZABLE_LOG) unless File.exist?(COUNTRIZABLE_LOG)
        ::ActiveRecord::Base.logger = Logger.new(COUNTRIZABLE_LOG)
